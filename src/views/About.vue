<template>
  <div class="my-10 mx-10 space-y-6 md:w-1/3 tb:w-2/5 tb:mx-auto md:mx-auto">
   ...
   <div class="tb:flex md:flex bg-gray-100 rounded-xl p-8 md:p-0 tb:p-0">
      <div class="w-6 h-6 bg-yellow-400 tb:w-36 tb:h-auto md:w-48 md:h-auto md:rounded-l-xl md:rounded-none tb:rounded-l-xl tb:rounded-none rounded-full mx-auto md:mx-0 tb:mx-0" />
      <div class="pt-6 md:p-8 tb:p-8 tb:text-center text-center md:text-left space-y-4">
        <h1 class="text-lg font-semibold">Qwanjai Deelertpradit</h1>
        <div class="font-medium">
          <h2 class="text-gray-800">62130500120</h2>
          <!-- <h3 class="text-gray-500">front-end</h3> -->
        </div>
      </div>
    </div>
