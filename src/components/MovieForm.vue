				...
				<w-form class="py-7 px-7 space-y-8 md:px-12 md:py-12">
					...
					<div class="grid grid-cols-2 gap-4">
						<div name="runningtime" class="space-y-4">
							...
							<w-input type="text" placeholder="ex. 2.45 H(s)" class="font-normal" color="black"></w-input>
						</div>
						<div name="studio" class="space-y-4">
							<label class="block tracking-wide text-gray-600 text-md font-semibold">Studio</label>
							<w-select :items="studios" placeholder="Can have only 1" color="black"></w-select>
						</div>
					</div>
					<div name="releaseddate" class="space-y-4">
						...
						<w-input type="date" class="font-normal" color="black"></w-input>
					</div>
					<div name="status" class="space-y-4">
						<label class="block tracking-wide text-gray-600 text-md font-semibold">Movie status</label>
						<w-select :items="status" placeholder="Can have only 1" color="black"></w-select>
					</div>
					...
					<div name="link" class="space-y-4">
						...
						<w-input type="url" placeholder="ex. https//youtu.be/xxxx" class="font-normal" color="black"></w-input>
					</div>
					<div name="plot" class>
