                    ...
                    <div class="container mt-2 pt-6 pb-8 bg-blackBlue md:bg-lightGray md:mt-0">
                        <div name="formsdetails">
                            <div name="moviename" class="flex mb-5">
                                ...
                                <!-- <div class="md:px-4 md:col-span-3 md:py-0 md:text-lg "> -->
                                    <w-input type="text" color="white" placeholder="ex. Iron Man" class="" outline >
                            ...
                            <div
                                class="grid grid-cols-2 gap-4 mb-5 md:grid md:grid-cols-2 md:gap-0"
                            >
                                <div name="filmgenre" class="formsBlock">
                                    <label
                                        class="formsLable md:px-10 md:text-right md:col-span-2 md:py-2 md:mt-2"
                                    >film genre</label>
                                ...
                                <div name="runtime" class="formsBlock">
                                    ...
                                    <input
                                        type="text"
                                        placeholder="hour(s)"
                                        class="formsInput md:col-span-2"
                                    />
                                    <span class="text-xl text-red-600"></span>
                                </div>
                            </div>
                            <div class="mb-5 md:grid md:grid-cols-2 md:gap-0">
                                ...
                                <div
                                    name="poster"
                                    class="formsBlock grid grid-flow-row mt-6 md:mt-0"
                                >
                                    <label
                                        class="formsLable md:px-12 md:text-right md:col-span-2 md:py-3"
                                    >poster</label>
                                    <input
                                        type="file"
                                        class="text-sm text-white md:col-span-2 md:pt-1"
                                    />
                                    <span class="text-xl text-red-600"></span>
                                </div>
                            </div>
                            <div name="plot" class="mb-5 formsBlock">
                                ...
                                <textarea
                                    rows="10"
                                    cols="39"
                                    class="formsInput md:col-span-3 md:py-0 md:text-lg"
                                />
                                <span class="text-xl text-red-600"></span>
                            </div>
                        </div>
