<template>
    <footer class="px-4 divide-y text-white">
        <div
            class="container flex flex-col justify-between items-center pb-10 mx-auto space-y-8 tb:mx-10 tb:flex-row md:space-y-0 md:flex-row md:space-y-0"
        >
            <div class="tb:w-1/3 md:w-1/3">
                <a href="#" class="flex justify-center space-x-3 md:justify-start">
                    <div class="flex items-center justify-center">
                        <router-link to="/">
                            <img class="w-16 tb:w-20 md:w-24" src="../assets/brm_logo.png" />
                        </router-link>
                    </div>
                    <span
                        class="self-center text-lg font-semibold tb:text-xl tb:mt-1 md:text-2xl md:mt-1"
                    >BRM Movies</span>
                </a>
            </div>
            <div
            ...
            >
                ...
                >
                    <h3>Policy</h3>
                    <div class="flex items-start space-x-3 tb:space-x-7 md:space-x-10">
                        ...
                        <a href="#" title="Twitter" class>
                            <svg
                                viewBox="0 0 24 24"
                                xmlns="http://www.w3.org/2000/svg"
                                class="w-5 h-5 md:w-7 md:h-7 fill-current"
                            >
                                <path
